...
export default function Layout() {
  ...
  return (
    <div className="h-screen flex bg-gray-50">
      {/* Modern Sidebar */}
      <aside className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 transform transition-transform duration-300 flex flex-col ${
        ...
        <div className="h-16 flex items-center px-6 border-b border-gray-200 flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-sm font-bold text-gray-900">СЭД "ЭСАСЫ ПИКИР"</h1>
        ...
        <nav className="flex-1 overflow-y-auto p-4 space-y-6">
          {/* Основная группа */}
          <div>
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2 px-3">Основное</p>
          ...
          {/* Управление */}
          <div>
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2 px-3">Управление</p>
            <div className="space-y-1">
          ...
          {/* Аналитика */}
          <div>
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2 px-3">Аналитика</p>
            <div className="space-y-1">
        ...
        <div className="p-4 border-t border-gray-200 flex-shrink-0">
          <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 transition cursor-pointer">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-500 truncate">{authUser?.position || ''}</p>
            </div>
            <button
              onClick={logout}
